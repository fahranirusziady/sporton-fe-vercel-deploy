  ...
  return (
    <header>
      ...
      <nav className="flex gap-44 font-medium">
        <Link href="#" className="relative inline-block font-medium after:content-[''] after:absolute after:left-1/2 after:-translate-x-1/2 after:-bottom-0 after:h-[3px] after:w-6 after:rounded-full after:bg-primary">Home</Link>
